...
-- 5. how many invoices were there in 2009, and what was the sales total for that year? (extra challenge: find the invoice
--count sales total for every year, using one query)
...
SELECT COUNT(InvoiceId) AS 'Number of Invoices in a country', BillingCountry AS 'Country', SUM(Total) AS sumTotal
FROM Invoice
